...
var SpinnerIcon = class _SpinnerIcon extends BaseIcon {
  ...
  static ɵfac = /* @__PURE__ */ (() => {
    ...
    return function SpinnerIcon_Factory(ɵt) {
      return (ɵSpinnerIcon_BaseFactory || (ɵSpinnerIcon_BaseFactory = ɵɵgetInheritedFactory(_SpinnerIcon)))(ɵt || _SpinnerIcon);
    };
  })();
...
var ButtonDirective = class _ButtonDirective {
  ...
  static ɵfac = function ButtonDirective_Factory(ɵt) {
    return new (ɵt || _ButtonDirective)(ɵɵdirectiveInject(ElementRef), ɵɵdirectiveInject(DOCUMENT));
  };
  static ɵdir = ɵɵdefineDirective({
...
var Button = class _Button {
  ...
  static ɵfac = function Button_Factory(ɵt) {
    return new (ɵt || _Button)(ɵɵdirectiveInject(ElementRef));
  };
  static ɵcmp = ɵɵdefineComponent({
    type: _Button,
    selectors: [["p-button"]],
...
var ButtonModule = class _ButtonModule {
  static ɵfac = function ButtonModule_Factory(ɵt) {
    return new (ɵt || _ButtonModule)();
  };
  static ɵmod = ɵɵdefineNgModule({
    type: _ButtonModule,
